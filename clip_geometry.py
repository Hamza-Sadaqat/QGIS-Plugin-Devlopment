...
class ClipWithGeometry:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ClipWithGeometry_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Clip With Geometry')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ClipWithGeometry', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/clip_geometry/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Clip with Updated Geometry'),
            callback=self.run,
    ...
    def run(self):
        ...
        self.dlg.comboBox_3.addItems(["Layer CRS","Project CRS","Ellipsoid"])
